...
const SettingsPage: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'general' | 'users' | 'security' | 'notifications' | 'database'>('general');
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">PostgreSQL Cache</h3>
                    <p className="text-sm text-gray-600">State & Orders</p>
                  </div>
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Parquet Catalog</h3>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">Size:</span>
                    <span className="font-medium">15.8 GB</span>
                  </div>
                  <div className="flex justify-between">
                ...
                <div className="mt-4 flex gap-2">
                  <button className="flex-1 px-3 py-2 text-sm bg-green-50 hover:bg-green-100 text-green-700 rounded-lg transition-colors">
                    Export
                  </button>
                  <button className="flex-1 px-3 py-2 text-sm bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-lg transition-colors">
                    Clean
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6">
                ...
                <div className="mt-4 flex gap-2">
                  <button className="flex-1 px-3 py-2 text-sm bg-purple-50 hover:bg-purple-100 text-purple-700 rounded-lg transition-colors">
                    Flush
                  </button>
                  <button className="flex-1 px-3 py-2 text-sm bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-lg transition-colors">
                    Stats
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                <button className="p-4 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg text-left transition-colors">
                  ...
                  <p className="text-xs md:text-sm text-blue-700 mt-1">Backup all databases</p>
                </button>
                <button className="p-4 bg-green-50 hover:bg-green-100 border border-green-200 rounded-lg text-left transition-colors">
                  ...
                  <p className="text-xs md:text-sm text-green-700 mt-1">Vacuum & analyze</p>
                </button>
                <button className="p-4 bg-purple-50 hover:bg-purple-100 border border-purple-200 rounded-lg text-left transition-colors">
                  ...
                  <p className="text-xs md:text-sm text-purple-700 mt-1">Export to CSV/JSON</p>
                </button>
                <button className="p-4 bg-orange-50 hover:bg-orange-100 border border-orange-200 rounded-lg text-left transition-colors">
                  ...
                  <p className="text-xs md:text-sm text-orange-700 mt-1">Database query logs</p>
                </button>
              </div>
            </div>
          </div>
